...
import { InstApi } from '../../apis/addres.api';
...
export class AddresApi{
    ...
    addresadd(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'addres/addresadd',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    addresup(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'addres/addresup',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
