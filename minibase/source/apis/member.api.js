...
export class MemberApi{
    ...
    upmem(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/upmem',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    upmember(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/upmember',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    upqiu(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/upqiu',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
