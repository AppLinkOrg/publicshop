...
export class MemberApi{
    ...
    update2(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/update2',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    update3(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/update3',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
